...
3. Ejecutar el analizador léxico en cada archivo de prueba:
   ```
   python lexer_runner.py test_min.txt
   python lexer_runner.py test_var.txt
   python lexer_runner.py test_control.txt
   python lexer_runner.py test_complete.txt
   python lexer_runner.py test_errors.txt
   ```
